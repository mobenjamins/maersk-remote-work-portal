        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm text-gray-400 font-light leading-relaxed mb-8">
              System detected recurring negative sentiment regarding the &ldquo;Permanent Establishment&rdquo; clause for sales roles in France.
              Users are requesting clarification on &ldquo;Contract Signing Authority&rdquo; definitions.
            </p>
            <button
            ...
            >
              ...
              <div className="flex-1 overflow-auto p-8 space-y-6">
                 <div className="bg-blue-50 border-l-4 border-maersk-blue p-4 text-xs text-maersk-dark leading-relaxed">
                    <span className="font-bold">AI Intent:</span> This draft addresses the negative sentiment in France by providing a granular definition of &ldquo;Contract Signing Authority&rdquo;, reducing ambiguity for Sales Directors.
                 </div>
