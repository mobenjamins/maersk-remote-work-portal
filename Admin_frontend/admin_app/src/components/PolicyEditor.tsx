...
const PolicyEditor = () => {
  ...
  const renderContentWithHighlights = (clause: PolicyClause) => {
    ...
    // This is a simplified highlighter for the prototype
    ...
    <div className="p-8 space-y-8 overflow-y-auto h-full relative">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-sm text-gray-500 font-light italic">Smart Clause System: Click on underlined variables to analyze policy impact.</p>
        </div>
        ...
        <div className="space-y-6">
            ...
            {activeVar ? (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-xl font-medium mb-6 italic">"{activeVar}"</div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-sm p-6">
            ...
            <p className="text-xs text-gray-600 font-light leading-relaxed">
              When updating variables like <span className="font-bold">"20 working days"</span>, ensure that local country labor laws are synced. AI will flag discrepancies.
            </p>
          </div>
        </div>
      </div>
