...
import { LayoutDashboard, FileText, BrainCircuit, ShieldAlert, LogOut } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="flex h-screen bg-background text-foreground overflow-hidden font-sans">
      {/* Maersk Sidebar - Dark Theme */}
      <nav className="w-72 bg-maersk-dark text-white flex flex-col shadow-xl z-20">
        <div className="p-8 border-b border-white/10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-xl font-bold tracking-tight">MAERSK</h1>
          </div>
          <p className="text-[10px] uppercase tracking-[0.2em] text-maersk-blue font-bold opacity-80">
        ...
        <div className="p-6 bg-black/20 border-t border-white/10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-sm bg-maersk-blue flex items-center justify-center font-bold text-white shadow-inner">
                BO
              </div>
              <div className="text-[11px]">
                <div className="font-bold text-white uppercase tracking-wider">B. Oghene</div>
