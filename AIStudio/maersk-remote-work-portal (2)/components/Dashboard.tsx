    ...
    <div className="max-w-[1200px] mx-auto px-8 py-12 animate-fade-in">
      ...
      <div className="flex justify-between items-end mb-12 border-b border-gray-200 pb-6">
        <div>
            ...
            <p className="text-gray-500 mt-2 font-light text-lg">Manage your international work requests and compliance.</p>
        </div>
        <div className="text-right">
             <div className="text-sm text-gray-400 uppercase tracking-widest font-semibold mb-1">Days Remaining</div>
             <div className="text-3xl font-light text-gray-900">20 <span className="text-lg text-gray-400">/ 20</span></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            {/* HR Admin Card (New) */}
            <div 
                onClick={() => setViewState(ViewState.HR_DASHBOARD)}
                className="bg-white group cursor-pointer border border-gray-200 rounded-sm shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden"
            >
                <div className="p-6 flex items-center justify-between">
                     <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 bg-slate-800 text-white rounded-sm flex items-center justify-center">
                             <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                        </div>
                        <div>
                            <h3 className="font-semibold text-gray-800">HR Admin Portal</h3>
                            <p className="text-xs text-gray-500">View analytics, global heatmaps, and compliance trends.</p>
                        </div>
                     </div>
                     <span className="text-[#42b0d5] text-sm font-medium group-hover:underline">Access Dashboard →</span>
                </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-sm shadow-sm">
                ...
                <table className="w-full text-sm text-left">
                    <thead className="bg-gray-50 text-gray-500 font-medium border-b border-gray-200">
                        <tr>
                            <th className="px-8 py-4 w-1/3">Request ID</th>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        <tr className="hover:bg-gray-50 transition-colors">
                            <td className="px-8 py-4 text-gray-900 font-medium">REQ-2024-892</td>
                            <td className="px-8 py-4 text-gray-600">United Kingdom</td>
                            <td className="px-8 py-4"><span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Approved</span></td>
                            <td className="px-8 py-4 text-gray-500 text-right">Oct 12, 2024</td>
                        </tr>
                        <tr className="hover:bg-gray-50 transition-colors">
                            <td className="px-8 py-4 text-gray-900 font-medium">REQ-2024-104</td>
                            <td className="px-8 py-4 text-gray-600">Spain</td>
                            <td className="px-8 py-4"><span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">Completed</span></td>
                            <td className="px-8 py-4 text-gray-500 text-right">Mar 04, 2024</td>
                        </tr>
                    </tbody>
                </table>
                 <div className="p-4 text-center text-xs text-gray-400 bg-gray-50 border-t border-gray-100">
                    Showing last 2 requests
                 </div>
            </div>
        </div>
